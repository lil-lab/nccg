...
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.dataset.CreateSparseFeatureAndStateDatasetWithExploration;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.dataset.CreateSparseFeatureDataset;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.dataset.CreateSparseFeatureDatasetWithExploration;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.learner.NeuralFeedForwardDotProductLearner;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.learner.NeuralFeedForwardLearner;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.learner.ValidationStatistics;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.AdjacentPOSFeatures;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.AdjacentWordFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.DynamicOriginFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.LexicalStepWordFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.LookaheadPOSFeatures;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.ParseStepSyntaxFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.StepRuleFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.local.features.TemplatAdjacentPOSFeature;
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.neuralparser.EnsembleShiftReduceParser;
...
import edu.cornell.cs.nlp.spf.parser.ff.shiftreduce.neuralparser.SimpleAMRShiftReduceParser;
...
import edu.uw.cs.lil.amr.features.decomposed.DecomposedFactoredLexicalFeatureSet;
import edu.uw.cs.lil.amr.features.decomposed.PosTagFeatureSet;
import edu.uw.cs.lil.amr.features.decomposed.ShiftHeadPredicateFeatureSet;
import edu.uw.cs.lil.amr.features.decomposed.SyntacticAttributeFeatureSet;
...
//import edu.uw.cs.lil.amr.neuralparser.AMRNeuralParser;
...
public class AmrNeuralResourceRepo extends ResourceCreatorRepository {
	
	public static final ILogger	LOG = LoggerFactory.create(AmrNeuralResourceRepo.class);
	
	public AmrNeuralResourceRepo() {
		// CCG parsing rules.
		...
		registerResourceCreator(new NeuralNetworkShiftReduceParser.Creator<>());
		registerResourceCreator(new NeuralShiftReduceParser.Creator<>());
		registerResourceCreator(new NeuralDotProductShiftReduceParser.Creator<>());
		//registerResourceCreator(new AMRNeuralParser.Creator());
		registerResourceCreator(new EnsembleShiftReduceParser.Creator<>());		
		registerResourceCreator(new LocalEnsembleNeuralDotProductShiftReduceParser.Creator<>());
		registerResourceCreator(new SimpleAMRShiftReduceParser.Creator<>());
		...
		registerResourceCreator(new CreateCompositeDecisionDataset.Creator<>());
		registerResourceCreator(new CreateSparseFeatureDataset.Creator<>());
		registerResourceCreator(new CreateSparseFeatureAndStateDataset.Creator<>());
		registerResourceCreator(new CreateSparseFeatureDatasetWithExploration.Creator<>());
		registerResourceCreator(new CreateSparseFeatureAndStateDatasetWithExploration.Creator<>());
		...
		//Next four features are decomposed features
		registerResourceCreator(new PosTagFeatureSet.Creator());
		registerResourceCreator(new SyntacticAttributeFeatureSet.Creator());
		registerResourceCreator(
				new DecomposedFactoredLexicalFeatureSet.Creator<>());
		registerResourceCreator(new ShiftHeadPredicateFeatureSet.Creator<>());
		//New features
		registerResourceCreator(new LookaheadPOSFeatures.Creator());
		registerResourceCreator(new StepRuleFeature.Creator());
		registerResourceCreator(new TemplatAdjacentPOSFeature.Creator());
		registerResourceCreator(new AdjacentPOSFeatures.Creator());
		registerResourceCreator(new DynamicOriginFeature.Creator());
		registerResourceCreator(new LexicalStepWordFeature.Creator());
		registerResourceCreator(new AdjacentWordFeature.Creator());
		registerResourceCreator(new ParseStepSyntaxFeature.Creator());
		...
		registerResourceCreator(new RNNShiftReduceLearner.Creator<>());
		registerResourceCreator(new NeuralFeedForwardLearner.Creator<>());
		registerResourceCreator(new NeuralFeedForwardDotProductLearner.Creator<>());
		//validation statistics used durign learning
		registerResourceCreator(new ValidationStatistics.Creator<>());
		...
		registerResourceCreator(
				new ExecTester.Creator<SituatedSentence<AMRMeta>, LogicalExpression, LabeledAmrSentence>());
		registerResourceCreator(
