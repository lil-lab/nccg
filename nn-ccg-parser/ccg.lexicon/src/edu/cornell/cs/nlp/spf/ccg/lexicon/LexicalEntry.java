...
public class LexicalEntry<MR> implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) { LOG.debug("LE fail code 1");
			return false;
		}
		if (getClass() != obj.getClass()) { LOG.debug("LE fail code 2");
			return false;
		}
		@SuppressWarnings("unchecked")
		final LexicalEntry<MR> other = (LexicalEntry<MR>) obj;
		if (!category.equals(other.category)) {  LOG.debug("LE fail code 3");
			return false;
		}
		if (dynamic != other.dynamic) { LOG.debug("LE fail code 4");
			return false;
		}
		if (!tokens.equals(other.tokens)) { LOG.debug("LE fail code 5");
			return false;
		}
		return true;
	}
