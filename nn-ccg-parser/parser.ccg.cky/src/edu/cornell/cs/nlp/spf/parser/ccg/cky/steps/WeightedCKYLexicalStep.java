...
/**
 * A {@link CKYLexicalStep} with a features and weight.
 *
 * @author Yoav Artzi
 * @param <MR>
 *            Meaning representation.
 */
public class WeightedCKYLexicalStep<MR>
		implements ILexicalParseStep<MR>, IWeightedCKYStep<MR> {
	...
	public WeightedCKYLexicalStep(CKYLexicalStep<MR> step,
		...
		assert !Double.isNaN(stepScore)
				&& !Double.isInfinite(stepScore) : "Invalid step score";
	...
	public boolean equals(Object obj) {
		...
		final WeightedCKYLexicalStep<MR> other = (WeightedCKYLexicalStep<MR>) obj;
	...
	public CKYLexicalStep<MR> getStep() {
		return this.step;
	}
