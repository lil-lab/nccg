...
public class AtisResourceRepo extends ResourceCreatorRepository {
	public AtisResourceRepo() {
		...
		registerResourceCreator(new LogicalExpressionCoordinationFeatureSet.Creator<IDataItem<Sentence>>());
		registerResourceCreator(new FactoredLexicon.Creator());
		registerResourceCreator(new SingleSentenceCollection.Creator());
		registerResourceCreator(new TemplateSupervisedGenlex.Creator<Sentence, SingleSentence>());
		registerResourceCreator(new SingleSentenceCollection.Creator());
		...
		registerResourceCreator(new Tester.Creator<Sentence, LogicalExpression, SingleSentence>());
		registerResourceCreator(new LexiconModelInit.Creator<Sentence, LogicalExpression>());
		registerResourceCreator(new UnificationGenlex.Creator<Sentence, SingleSentence>());
