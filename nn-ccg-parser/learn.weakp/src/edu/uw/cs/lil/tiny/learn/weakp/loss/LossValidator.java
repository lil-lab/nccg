 ...
 * @param <MR>
 */
public class LossValidator<MR> implements IValidator<Sentence, MR> {
	
	private final ILossFunction<MR>	lossFunction;
	private final double			threshold;
	
	public LossValidator(ILossFunction<MR> lossFunction, double threshold) {
		this.lossFunction = lossFunction;
		this.threshold = threshold;
	}
	
	@Override
	public boolean isValid(Sentence dataItem, MR label) {
