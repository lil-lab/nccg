 ...
 * @param <MR>
 */
public class CompositeLossFunction<MR> extends AbstractScaledLossFunction<MR> {
	
	private final List<ILossFunction<MR>>	lossFunctions;
	
	public CompositeLossFunction(double scale,
			List<ILossFunction<MR>> lossFunctions) {
		super(scale);
		this.lossFunctions = lossFunctions;
	}
	
	public CompositeLossFunction(List<ILossFunction<MR>> lossFunctions) {
