 ...
 * @author Yoav Artzi
 */
public class ParsingOp<MR> implements Serializable {

	private static final long serialVersionUID = 3165168365557998500L;
	public static final ILogger	LOG = LoggerFactory.create(ParsingOp.class);
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) {	LOG.debug("PO Code 1");
			return false;
		}
		if (getClass() != obj.getClass()) { LOG.debug("PO Code 2");
			return false;
		}
		@SuppressWarnings("unchecked")
		final ParsingOp<MR> other = (ParsingOp<MR>) obj;
		if (!category.equals(other.category)) { LOG.debug("PO Code 3");
			return false;
		}
		if (!rule.equals(other.rule)) { LOG.debug("PO Code 4");
			return false;
		}
		if (!span.equals(other.span)) { LOG.debug("PO Code 5");
			return false;
		}
		return true;
	}
