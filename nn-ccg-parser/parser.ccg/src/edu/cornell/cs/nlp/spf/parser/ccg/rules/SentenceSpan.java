 ...
 * @author Yoav Artzi
 */
public class SentenceSpan extends Span implements Serializable {

	private static final long serialVersionUID = 8461721570300299700L;
	private final int	sentenceLength;

	public SentenceSpan(int start, int end, int sentenceLength) {
		super(start, end);
		assert end <= sentenceLength : "end is "+end+" and sentence length is "+sentenceLength;
