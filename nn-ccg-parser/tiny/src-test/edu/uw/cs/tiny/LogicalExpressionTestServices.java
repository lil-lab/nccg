...
public class LogicalExpressionTestServices {
	...
	private static DecoderHelper<LogicalExpression>				DECODER_HELPER;
	...
	static {
		...
		DECODER_HELPER = new DecoderHelper<LogicalExpression>(CATEGORY_SERVICES);
	...
	public static DecoderHelper<LogicalExpression> getDecoderHelper() {
