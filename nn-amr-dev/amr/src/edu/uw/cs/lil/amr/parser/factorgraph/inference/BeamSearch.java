...
import edu.cornell.cs.nlp.utils.collections.queue.OrderInvariantBoundedPriorityQueue;
...
public class BeamSearch {
	...
	public static Pair<List<EvaluationResult>, Boolean> of(FactorGraph graph,
			int beamSize, boolean orderInvariant) {
		return of(graph, beamSize, false, orderInvariant);
	}

	public static Pair<List<EvaluationResult>, Boolean> of(FactorGraph graph,
			int beamSize, boolean sloppy, boolean orderInvariant) {
		...
		for (final INode variable : variables) {
			...
			final PriorityQueue<Configuration> queue = orderInvariant
					? new BoundedPriorityQueue<>(beamSize,
							(c1, c2) -> Double.compare(c1.getScore(),
									c2.getScore()))
					: new OrderInvariantBoundedPriorityQueue<>(beamSize,
							(c1, c2) -> Double.compare(c1.getScore(),
									c2.getScore()));
			StreamSupport
