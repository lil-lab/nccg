...
//			if(labeledAmrSentence.getSample().getSample().getTokens().size() <= 15/*10*/) {
				
//				final String sentence = labeledAmrSentence.getSample().getString();
//				LOG.info("sentence %s", sentence);
//				if(sentence.compareTo("The message was signed as the new blood.") != 0) {
//					continue;
//				}
...
//			}
		...
		//work on first 10
		//filterAmrSentences.subList(0, 10);
